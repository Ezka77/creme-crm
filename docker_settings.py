...
DATABASES = {
    'default': {
        'ENGINE':   'django.db.backends.postgresql_psycopg2', # 'postgresql_psycopg2', 'mysql', 'sqlite3' ('oracle' backend is not working with creme for now).
        'NAME':     os.environ.get('DB_NAME', 'creme'),        # Or path to database file if using sqlite3.
        'USER':     os.environ.get('DB_USER', 'creme'),        # Not used with sqlite3.
        'PASSWORD': os.environ.get('DB_PASS', 'creme'),        # Not used with sqlite3.
...
SECRET_KEY = os.environ.get('SECRET_KEY',
        '1&7rbnl7u#+j-2#@5=7@Z0^9v@y_Q!*y^krWS)r)39^M)9(+6(')
...
#        'APP_DIRS': False,
        'OPTIONS': {
            ...
            'loaders': [
                ('django.template.loaders.cached.Loader', (  # Don't use cached loader when developing (in your local_settings.py)
                    'django.template.loaders.filesystem.Loader',
                    'django.template.loaders.app_directories.Loader',
                    #'django.template.loaders.eggs.Loader',
                )),
...
EMAIL_SENDER        = os.environ.get('EMAIL_SENDER', 'sender@domain.org')  # This is a Creme parameter which specifies from_email (sender) when sending email.
